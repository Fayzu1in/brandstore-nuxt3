...
export const CATALOG_MOCK_DATA: Record<string, CategoryData> = {
  'dlya-gejmerov': {
    ...
    subcategories: [
      ...
      { id: 102, title: 'Игровые кресла', slug: 'igrovye-kresla', icon: 'mdi:chair-rolling' },
      { id: 103, title: 'Игровые наборы', slug: 'igrovye-nabory', icon: 'mdi:package-variant-closed' },
      { id: 104, title: 'Игровые клавиатуры', slug: 'igrovye-klaviatury', icon: 'mdi:keyboard-outline' },
      { id: 105, title: 'Игровые мыши', slug: 'igrovye-myshi', icon: 'mdi:mouse' },
      { id: 106, title: 'Игровые кейсы', slug: 'igrovye-kejsy', icon: 'mdi:desktop-tower font' },
      { id: 107, title: 'Игровые наушники', slug: 'igrovye-naushniki', icon: 'mdi:headphones' },
      { id: 108, title: 'Игровые коврики', slug: 'igrovye-kovriki', icon: 'mdi:rug' },
      { id: 109, title: 'Игровые столы', slug: 'igrovye-stoly', icon: 'mdi:desk' },
      { id: 110, title: 'Микрофоны', slug: 'mikrofony', icon: 'mdi:microphone-outline' },
    ]
  },
